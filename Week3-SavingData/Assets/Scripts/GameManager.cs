...
public class GameManager : MonoBehaviour
{
    ...
    const string FILE_CLICKS = DIR_LOGS + "/mouseClicks.txt"; 
    string FILE_PATH_MOUSE_CLICKS;
    ...
    private void Start()
    {
        FILE_PATH_MOUSE_CLICKS = Application.dataPath + FILE_CLICKS; 
    }
    ...
    void Update()
    {
        ...
        if (!File.Exists(FILE_PATH_MOUSE_CLICKS))
        {
            Directory.CreateDirectory(Application.dataPath + DIR_LOGS);
        }
        File.WriteAllText(FILE_PATH_MOUSE_CLICKS, mouseClick + "");
    }
